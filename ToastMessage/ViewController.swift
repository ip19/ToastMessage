...
//  ToastMessage
//
//  Created by Ievgenii Poberezhnyi on 23.01.2020.
//  Copyright © 2020 Ievgenii Poberezhnyi. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func Button(_ sender: UIButton) {
        ...
        if firstField.text == ""
        {
            ...
            self.view.showToast(toastMessage: "Please Enter Username,beacuse it is necessary to add For getting logged in.", duration: 30)
        }
